...
export default function Home() {
  ...
  <ul className="mx-auto flex cursor-pointer justify-between tracking-widest items-center font-satoshi text-gray-400 px-4 py-6 gap-6 opacity-100 bg-white border-[1px] ">
   ...
   <li>Home</li>
    ...
    <h1>Search</h1>
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-500 hover:text-gray-800 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M11 4a7 7 0 1 1 0 14 7 7 0 0 1 0-14zM20 20l-4-4"></path>
</svg>
